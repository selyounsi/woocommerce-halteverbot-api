<div class="analytics-section">
    ...
    <?php if (!empty($report["traffic_metrics"]["gsc_keywords"])): ?>
        <div class="postbox">
            <div class="inside">
                <h2 class="hndle"><span>Google Search Console Keywords</span></h2>
                <table class="widefat fixed striped">
                    <thead><tr><th>Keyword</th><th>Clicks</th><th>Anteil</th></tr></thead>
                    <tbody>
                        <?php foreach ($report["traffic_metrics"]["gsc_keywords"] as $keyword): ?>
                            <tr>
